...
const EXISTING_TRANSLATIONS = {
  app_name:            { en:"Agri Guard AI", hi:"एग्री गार्ड एआई", bn:"অ্যাগ্রি গার্ড এআই", te:"అగ్రి గార్డ్ ఏఐ", mr:"अॅग्री गार्ड एआय", ta:"அக்ரி கார்ட் ஏஐ", ur:"ایگری گارڈ اے آئی", gu:"એગ્રી ગાર્ડ એઆઈ", kn:"ಅಗ್ರಿ గార్డ్ ఎఐ", ml:"അഗ്രി ഗാർഡ് എഐ", or:"ଅଗ୍ରି ଗାର୍ଡ ଏଆଇ", sw:"Agri Guard AI", am:"አግሪ ጋርድ ኤአይ", ha:"Agri Guard AI", yo:"Agri Guard AI", ig:"Agri Guard AI", zu:"Agri Guard AI", fr:"Agri Guard IA", pt:"Agri Guard IA", es:"Agri Guard IA", ar:"أجري جارد للذكاء الاصطناعي", id:"Agri Guard AI", vi:"Agri Guard AI", th:"แอกรี การ์ด เอไอ" },
  tagline:             { en:"Your AI Farming Assistant", hi:"आपका एआई कृषि सहायक", bn:"আপনার এআই কৃষি সহায়ক", te:"మీ AI వ్యవసాయ సహాయకుడు", mr:"तुमचा एआय शेती सहाय्यक", ta:"உங்கள் AI விவசாய உதவியாளர்", ur:"آپ کا AI زرعی معاون", gu:"તમારા AI ખેતી સહાયક", kn:"ನಿಮ್ಮ AI ಕೃಷಿ ಸಹಾಯಕ", ml:"നിങ്ങളുടെ AI കൃഷി സഹായി", or:"ଆପଣଙ୍କ AI କୃଷି ସହାୟକ", sw:"Msaidizi Wako wa Kilimo wa AI", am:"የእርስዎ AI የእርሻ ረዳት", ha:"Mataimakin Noma AI Ku", yo:"Olùrànlọ́wọ́ Ogbin AI Rẹ", ig:"Olùrànlọ́wọ́ Ogbin AI Rẹ", zu:"Umsizi Wakho Wezolimo we-AI", fr:"Votre Assistant Agricole IA", pt:"Seu Assistente Agrícola IA", es:"Tu Asistente Agrícola IA", ar:"مساعدك الزراعي بالذكاء الاصطناعي", id:"Asisten Pertanian AI Anda", vi:"Trợ Lý Nông Nghiệp AI Của Bạn", th:"ผู้ช่วยเกษตร AI ของคุณ" },
  nav_scan:     { en:"Scan", hi:"स्कैन", bn:"स्कैन", te:"స్కాన్", mr:"स्कॅन", ta:"ஸகே்ன்", ur:"اسکین", gu:"સ્કેન", kn:"ಸ್ಕ್ಯಾನ್", ml:"സ്കാൻ", or:"ସ୍କ୍ୟାନ", sw:"Skani", am:"ቅኝት", ha:"Bincike", yo:"Ṣe Ayẹwo", ig:"Nyochaa", zu:"Skena", fr:"Scanner", pt:"Escanear", es:"Escanear", ar:"مسح", id:"Pindai", vi:"Quét", th:"สแกน" },
  nav_weather:  { en:"Weather", hi:"मौसम", bn:"আবহাওয়া", te:"వాతావరణం", mr:"हवामान", ta:"வானிலை", ur:"موسم", gu:"હવામાન", kn:"ಹವಾಮಾನ", ml:"കാലാവസ്ഥ", or:"ପାଗ", sw:"Hali ya Hewa", am:"የአየር ሁኔታ", ha:"Yanayin Yanayi", yo:"Ojú Ọjọ", ig:"Ihu Igwe", zu:"Isimo Sezulu", fr:"Météo", pt:"Clima", es:"Clima", ar:"الطقس", id:"Cuaca", vi:"Thời tiết", th:"สภาพอากาศ" },
  ...
  nav_alerts:   { en:"Alerts", hi:"अलर्ट", bn:"সতর্কতা", te:"హెచ్చరికలు", mr:"सूचना", ta:"எச்சரிக்கைகள்", ur:"الرट्स", gu:"ચેતવણીઓ", kn:"ಎಚ್ಚరిಕೆಗಳು", ml:"അലർട്ടുകൾ", or:"ସତର୍କତା", sw:"Arifa", am:"ማንቂያዎች", ha:"Faɗakarwa", yo:"Ìkìlọ̀", ig:"Ọchịchọ", zu:"Izexwayiso", fr:"Alertes", pt:"Alertas", es:"Alertas", ar:"التنبيهات", id:"Peringatan", vi:"Cảnh báo", th:"การแจ้งเตือน" },
  nav_profile:  { en:"Profile", hi:"प्रोफ़ाइल", bn:"প্রোফাইল", te:"ప్రొఫైల్", mr:"प्रोफाइल", ta:"சுயவிவரம்", ur:"پروفائل", gu:"પ્રોફાઇલ", kn:"ಪ್ರொಫೈಲ್", ml:"പ്രൊഫൈൽ", or:"ପ୍ରୋଫାଇଲ", sw:"Wasifu", am:"መገለጫ", ha:"Bayani", yo:"Profaili", ig:"Profaili", zu:"Iphrofayili", fr:"Profil", pt:"Perfil", es:"Perfil", ar:"الملف الشخصي", id:"Profil", vi:"Hồ sơ", th:"โปรไฟล์" },
  btn_continue:     { en:"Continue", hi:"जारी रखें", bn:"চালিয়ে যান", te:"కొనసాగించు", mr:"सुरू ठेवा", ta:"தொடரவும்", ur:"جاری رکھیں", gu:"ચાલુ રાખો", kn:"ಮುಂದುverify", ml:"തുടരുക", or:"ଜାରି ରଖନ୍ତୁ", sw:"Endelea", am:"ቀጥሉ", ha:"Ci gaba", yo:"Tẹ̀síwájú", ig:"Gaa n'ihu", zu:"Qhubeka", fr:"Continuer", pt:"Continuar", es:"Continuar", ar:"متابعة", id:"Lanjutkan", vi:"Tiếp tục", th:"ดำเนินการต่อ" },
  btn_save:         { en:"Save", hi:"सहेजें", bn:"সংরক্ষণ করুন", te:"సేవ్ చేయి", mr:"जतन करा", ta:"சேமி", ur:"محفوظ کریں", gu:"સાચવો", kn:"ಉಳಿಸಿ", ml:"സേവ് ചെയ്യുക", or:"ସଞ୍ଚୟ କରନ୍ତୁ", sw:"Hifadhi", am:"አስቀምጥ", ha:"Ajiye", yo:"Fipamọ́", ig:"Chekwaa", zu:"Londoloza", fr:"Enregistrer", pt:"Salvar", es:"Guardar", ar:"حفظ", id:"Simpan", vi:"Lưu", th:"บันทึก" },
  ...
  btn_cancel:       { en:"Cancel", hi:"रद्द करें", bn:"বাতিল করুন", te:"రద్దు చేయి", mr:"रद्द करा", ta:"ரத்துசெய்", ur:"منسوخ کریں", gu:"રદ કરો", kn:"ರದ್ದುಮಾಡಿ", ml:"ರദ്ദാക്കുക", or:"ବାତିଲ କରନ୍ତୁ", sw:"Ghairi", am:"ሰርዝ", ha:"Soke", yo:"Fagilé", ig:"Kagbuo", zu:"Khansela", fr:"Annuler", pt:"Cancelar", es:"Cancelar", ar:"إلغاء", id:"Batal", vi:"Hủy", th:"ยกเลิก" },
  btn_back:         { en:"Back", hi:"वापस", bn:"পিছনে", te:"వెనక్కి", mr:"मागे", ta:"பின்", ur:"پیچھے", gu:"પાછળ", kn:"ಹಿಂದೆ", ml:"പിന്നോട്ട്", or:"ପଛକୁ", sw:"Rudi", am:"ተመለስ", ha:"Komawa", yo:"Padà", ig:"Laghachi", zu:"Emuva", fr:"Retour", pt:"Voltar", es:"Volver", ar:"رجوع", id:"Kembali", vi:"Quay lại", th:"กลับ" },
  btn_search:       { en:"Search", hi:"खोजें", bn:"अनुসন্ধान करें", te:"வெతుకు", mr:"शोधा", ta:"தேடு", ur:"تلاش کریں", gu:"શોધો", kn:"ಹುಡುಕಿ", ml:"തിരയുക", or:"ଖୋଜନ୍ତୁ", sw:"Tafuta", am:"ፈልግ", ha:"Bincika", yo:"Ìwádìí", ig:"Chọọ", zu:"Sesha", fr:"Rechercher", pt:"Pesquisar", es:"Buscar", ar:"بحث", id:"Cari", vi:"Tìm kiếm", th:"ค้นหา" },
  btn_sign_out:     { en:"Sign Out", hi:"साइन आउट", bn:"사인 आउट", te:"సైన్ అవుట్", mr:"साइन आउट", ta:"வெளியேறு", ur:"سائن آؤٹ", gu:"સાઇન આઉટ", kn:"ಸೈನ್ ಔಟ್", ml:"సైൻ ಔട്ട്", or:"ସାଇନ ଆଉଟ", sw:"Toka", am:"ውጣ", ha:"Fita", yo:"Jade", ig:"Pụọ", zu:"Phuma", fr:"Se déconnecter", pt:"Sair", es:"Cerrar sesión", ar:"تسجيل الخروج", id:"Keluar", vi:"Đăng xuất", th:"ออกจากระบบ" },
  btn_edit:         { en:"Edit Profile", hi:"प्रोफ़ाइल संपादित करें", bn:"প্রোফাইল সম্পাদনা", te:"ప్రొఫైల్ సవరించు", mr:"प्रोफाइल संपादित करा", ta:"சுயவிவரத்தை திருத்து", ur:"پروفائل ترمیم करें", gu:"प्रोफाइल संपादित करो", kn:"ಪ್ರೊಫೈಲ್ ಸಂಪಾದಿಸಿ", ml:"പ്രൊഫൈൽ എഡിറ്റ് ചെയ്യുക", or:"ପ୍ରୋଫାଇଲ ସମ୍ପାଦନ", sw:"Hariri Wasifu", am:"መገለጫ አርትዕ", ha:"Gyara Bayani", yo:"Ṣàtúnṣe Profaili", ig:"Dezie Profaili", zu:"Hlela Iphrofayili", fr:"Modifier le profil", pt:"Editar perfil", es:"Editar perfil", ar:"تعديل الملف", id:"Edit Profil", vi:"Sửa hồ sơ", th:"แก้ไขโปรไฟล์" },
  btn_scan_again:   { en:"Scan Another Plant", hi:"दूसरे पौधे को स्कैन करें", bn:"আরেকটি গাছ স্ক্যান করুন", te:"మరో మొక్కను స్కాన్ చేయి", mr:"दुसरी वनस्पती स्कॅन करा", ta:"மற்றொரு தாவரத்தை ஸ்கேன் செய்", ur:"ایک और पودا اسکین کریں", gu:"બીજો છોડ સ્કેન કરો", kn:"ಮತ್ತೊಂದು ಸಸ್ಯ ಸ್ಕ್ಯಾನ್ ಮಾಡಿ", ml:"മറ്റொரு സസ്യം സ്കാൻ ചെയ്യുക", or:"ଆଉ ଏକ ଉଦ୍ଭିଦ ସ୍କ୍ୟାନ କରନ୍ତୁ", sw:"Skani Mmea Mwingine", am:"ሌላ ተክል ቅኝ", ha:"Duba Wata Shuka", yo:"Ṣe Ayẹwo Ọ̀gbìn Mìíràn", ig:"Nyochaa Osisi Ọzọ", zu:"Skena Usehlakalo Olukhác", fr:"Scanner une autre plante", pt:"Escanear outra planta", es:"Escanear outra planta", ar:"مسح نبات آخر", id:"Pindai Tanaman Lain", vi:"Quét cây khác", th:"สแกนพืชอื่น" },
  btn_retry:        { en:"Tap to retry", hi:"पुनः प्रयास करें", bn:"পুনরায় চেষ্টা করুন", te:"మళ్ళీ ప్రయత్నించు", mr:"पुन्हा प्रयत्न करा", ta:"மீண்டும் முயற்சி செய்", ur:"دوبارہ कोशिश करें", gu:"ફરી પ્રયાસ કરો", kn:"ಮತ್ತೆ ప్రయత్ನಿಸಿ", ml:"വീണ്ടും ശ്രമിക്കുക", or:"ପୁଣି ଚେଷ୍ଟା କରନ୍ତୁ", sw:"Gusa kurudia", am:"እንደገና ሞክር", ha:"Danna don sake gwadawa", yo:"Tẹ láti tún gbìyanjú", ig:"Pịa iji nwaa ọzọ", zu:"Thepha ukuphinda uzame", fr:"Appuyer pour réessayer", pt:"Toque para tentar novamente", es:"Toca para reintentar", ar:"انقر للمحاولة مجددًا", id:"Ketuk untuk mencoba lagi", vi:"Nhấn để thử lại", th:"แตะเพื่อลองใหม่" },
  ...
  btn_read_aloud:   { en:"Read Aloud", hi:"ज़ोर से पढ़ें", bn:"জোরে পড়ুন", te:"బిగ్గరగా చదువు", mr:"मोठ्याने वाचा", ta:"சத்தமாக படி", ur:"اونचा پڑھیں", gu:"મોટેથી વાંચો", kn:"ಜೋರಾಗಿ ಓದಿ", ml:"ഉറക്കെ വായിക്കുക", or:"ଜୋରରେ ପଢ଼ନ୍ତୁ", sw:"Soma Kwa Sauti", am:"በጮክ ብሎ አንብብ", ha:"Karanta Daga Tsayi", yo:"Ka Sókè", ig:"Gụọ n'ụda", zu:"Funda Ngezwi", fr:"Lire à voix haute", pt:"Ler em voz alta", es:"Leer en voz alta", ar:"اقرأ بصوت عالٍ", id:"Baca Keras", vi:"Đọc to", th:"อ่านออกเสียง" },
  sec_todays_advice:   { en:"Today's Advice", hi:"आज की सलाह", bn:"आजकर परामर्श", te:"నేటి సలహా", mr:"आजचा सल्ला", ta:"இன்றைய ஆலோசனை", ur:"آج کا مشورہ", gu:"આજની સલાહ", kn:"ಇಂದಿನ ಸಲಹೆ", ml:"ഇന്നത്തെ ഉപദേശം", or:"ଆଜିର ପରାମର୍ଶ", sw:"Ushauri wa Leo", am:"የዛሬ ምክር", ha:"Shawarar Yau", yo:"Ìmọ̀ràn Ọjọ́ Yìí", ig:"Ndụmọdụ Taa", zu:"Iseluleko Sanamuhla", fr:"Conseils du jour", pt:"Conselho de hoje", es:"Consejo de hoy", ar:"نصيحة اليوم", id:"Saran Hari Ini", vi:"Lời khuyên hôm nay", th:"คำแนะนำวันนี้" },
  ...
  sec_market_prices:   { en:"Market Prices", hi:"बाज़ार भाव", bn:"बाजार दर", te:"మార్కెట్ ధరలు", mr:"बाजारभाव", ta:"சந்தை விலைகள்", ur:"بازار کی कीमतें", gu:"બજાર ભાવ", kn:"ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳು", ml:"മാർക്കറ്റ് വിലകൾ", or:"ବଜାର ମୂଲ୍ୟ", sw:"Bei za Soko", am:"የገበያ ዋጋዎች", ha:"Farashin Kasuwa", yo:"Iye Ọjà", ig:"Ọnụahịa Ahịa", zu:"Amanani Emakethe", fr:"Prix du marché", pt:"Preços de mercado", es:"Precios de mercado", ar:"أسعار السوق", id:"Pasar", vi:"Giá thị trường", th:"ราคาตลาด" },
  sec_alerts:          { en:"Alerts", hi:"सूचनाएं", bn:"সतর্কতা", te:"హెచ్చరికలు", mr:"सूचना", ta:"எச்சரிக்கைகள்", ur:"الرٹ", gu:"ચેતવણીઓ", kn:"ಎಚ್ಚరిಕೆಗಳು", ml:"അലർട്ടുകൾ", or:"ସତର୍କତା", sw:"Arifa", am:"ማንቂያዎች", ha:"Faɗakarwa", yo:"Ìkìlọ̀", ig:"Ọchịchọ", zu:"Izexwayiso", fr:"Alertes", pt:"Alertas", es:"Alertas", ar:"التنبيهات", id:"Peringatan", vi:"Cảnh báo", th:"การแจ้งเตือน" },
  ...
  lbl_country:         { en:"Country", hi:"देश", bn:"देश", te:"దేశం", mr:"देश", ta:"நாடு", ur:"ملک", gu:"દેશ", kn:"ದೇಶ", ml:"രാജ്യം", or:"ଦେଶ", sw:"Nchi", am:"ሀገር", ha:"Ƙasa", yo:"Orílẹ̀-èdè", ig:"Mba", zu:"Izwe", fr:"Pays", pt:"País", es:"País", ar:"البلد", id:"Negara", vi:"Quốc gia", th:"ประเทศ" },
  lbl_farm_size:       { en:"Farm Size", hi:"खेत का आकार", bn:"খামারের আকার", te:"పొలం పరిమాణం", mr:"शेताचा आकार", ta:"பண்ணையின் அளவு", ur:"فार्म का साइज", gu:"ખેતરનું કદ", kn:"ಫಾರ್ಮ್ ಗಾತ್ರ", ml:"ഫാം വലിപ്പം", or:"ଫାର୍ମ ଆକାର", sw:"Ukubwa wa Shamba", am:"የእርሻ መጠን", ha:"Girman Gona", yo:"Ìwọ̀n Oko", ig:"Ogo Ubi", zu:"Ubukhulu Bepulazi", fr:"Taille de la ferme", pt:"Tamanho da fazenda", es:"Tamaño de la finca", ar:"حجم المزرعة", id:"Ukuran Lahan", vi:"Diện tích trang trại", th:"ขนาดฟาร์ม" },
  lbl_language:        { en:"Language", hi:"भाषा", bn:"ভাষা", te:"భాష", mr:"भाषा", ta:"மொழி", ur:"زبان", gu:"ભાષા", kn:"ಭಾಷೆ", ml:"ಭಾಷ", or:"ଭାଷା", sw:"Lugha", am:"ቋንቋ", ha:"Harshe", yo:"Èdè", ig:"Asụsụ", zu:"Ulimi", fr:"Langue", pt:"Idioma", es:"Idioma", ar:"اللغة", id:"Bahasa", vi:"Ngôn ngữ", th:"ภาษา" },
